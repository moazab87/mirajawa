(function (e) {
    ...
    var y = {};
    r.isSupported =
        typeof m.createHTMLDocument !== "undefined" && n.documentMode !== 9;
    var b = function (e, t) {
        var r = t.length;
        while (r--) {
    ...
    var P = function (e) {
        ...
        L = e.SAFE_FOR_JQUERY || false;
        D = e.SAFE_FOR_TEMPLATES || false;
    ...
    var Q = function (e) {
        ...
        re("uponSanitizeElement", e, { tagName: t });
        if (!x[t] || E[t]) {
    ...
    var ee = function (e) {
        ...
        f = { attrName: "", attrValue: "", keepAttr: true };
        c = s.length;
        while (c--) {
            r = s[c];
            a = r.name;
            ...
            f.attrValue = i;
            f.keepAttr = true;
            re("uponSanitizeAttribute", e, f);
            i = f.attrValue;
            if (o === "name" && e.nodeName === "IMG" && s.id) {
                l = s.id;
    ...
    var te = function (e) {
        var t;
        var r = K(e);
        re("beforeSanitizeShadowDOM", e, null);
        while ((t = r.nextNode())) {
            re("uponSanitizeShadowNode", t, null);
            if (Q(t)) {
                continue;
            }
