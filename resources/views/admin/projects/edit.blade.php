                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="{{ __('admin.name') }}" required value="{{ old('name', $model->name) }}">
                                @error('name')
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="form-select" id="team_id" name="team_id" required>
                                    <option value="" disabled {{ old('team_id', $model->team_id) ? '' : 'selected' }}>
                                        {{ __('admin.select') }}
                                    </option>
                                    @foreach ($teams ?? [] as $key => $team)
                                        <option value="{{ $key }}"
                                            {{ old('team_id', $model->team_id) == $key ? 'selected' : '' }}>
                                            {{ $team }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="form-select" id="client_id" name="client_id">
                                    <option value="" disabled
                                        {{ old('client_id', $model->client_id) ? '' : 'selected' }}>
                                        {{ __('admin.select') }}
                                    </option>
                                    @foreach ($clients ?? [] as $key => $client)
                                        <option value="{{ $key }}"
                                            {{ old('client_id', $model->client_id) == $key ? 'selected' : '' }}>
                                            {{ $client }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="date" class="form-control" id="start_date" name="start_date"
                                    value="{{ old('start_date', optional($model->start_date)->format('Y-m-d')) }}" required>
                                @error('start_date')
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="date" class="form-control" id="end_date" name="end_date"
                                    value="{{ old('end_date', optional($model->end_date)->format('Y-m-d')) }}">
                                @error('end_date')
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4" placeholder="{{ __('admin.description') }}">{{ old('description', $model->description) }}</textarea>
                                @error('description')
