...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <x-admin.table :headers="['#', __('dashboard.year'), __('dashboard.name'), __('dashboard.status'), __('dashboard.actions')]" :createRoute="$createRoute" :title="$title" :buttonText="__('dashboard.add')" :search="true" :indexRoute="$route">
