...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <x-admin.table :headers="['#', __('dashboard.name'), __('dashboard.email'), __('dashboard.status'), __('dashboard.actions')]" :title="$title" :search="true" :indexRoute="$route" :createRoute="null">
