            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('admin.roles.edit', $model->id) }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">{{ __('admin.permissions') }}</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            @empty
                                                <p class="text-muted mb-0">{{ __('admin.no_permissions_assigned') }}</p>
                                            @endforelse
                                        </div>
